...
<div class="row footer" id="footer">
	<div class="col-md-12 top_footer">
		<h3 class="underline">
			...
			</span> <a href="${pageContext.request.contextPath}/logout" class="float_right font_20">Logout&nbsp|&nbsp</a>
		</h3>
	</div>
	<div class="col-md-6">
...
<script type='text/javascript'
	src='${pageContext.request.contextPath}/templates/js/plugins/bootstrap/bootstrap-select.js'></script>

<script type='text/javascript'
	src='${pageContext.request.contextPath}/templates/js/plugins/validationengine/languages/jquery.validationEngine-en.js'></script>
<script type='text/javascript'
	src='${pageContext.request.contextPath}/templates/js/plugins/validationengine/jquery.validationEngine.js'></script>

<script type='text/javascript'
	src='${pageContext.request.contextPath}/templates/js/plugins/jquery-validation/jquery.validate.js'></script>

<script type='text/javascript'
	src='${pageContext.request.contextPath}/templates/js/plugins/maskedinput/jquery.maskedinput.min.js'></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/templates/js/plugins/bootstrap/bootstrap-file-input.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/templates/js/plugins/bootstrap/bootstrap-select.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/templates/js/plugins/tagsinput/jquery.tagsinput.min.js"></script>
